...
export default {
  ...
  data() {
    return {
      ...
      beneficiarieID: this.$route.params.id,
  ...
  methods: {
    getData() {
      axios({
        method: "GET",
        url: this.beneficiariesURL + "/" + this.beneficiarieID
      })
        .then(response => {
          ...
          this.estructuraFamiliar = data.estructuraFamiliar;
          this.seguridadSocial = data.seguridadSocial;
          this.servicios = data.servicios;

          this.servicios.luz = data.servicios.luz;
          this.servicios.luz.planta = data.servicios.luz.planta;
